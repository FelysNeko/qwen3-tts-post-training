...
- `w100_score.py <half>` — 双 scorer 打分（half 0/1 按全局条目奇偶分半，HTTP 端口 8000/8001）；report_h{0,1}.json 逐组 flush、断点续。产出：`{eval_root}/report_h{0,1}.json`（组键 `{voice}/{cat}_{pi:02d}`，take 行 {dur, utmosv2, p835, cer, sim}）。
